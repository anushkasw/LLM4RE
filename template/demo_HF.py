...
class Demo_HF:
    def __init__(self, access_token, model_name, temperature, max_tokens, top_p, frequency_penalty, presence_penalty, logprobs):
        self.pipeline = HFModelPipelines(access_token).get_pipeline(model_name)
